"""
Django settings for celfocus_demo_appli_46060 project.
...
ROOT_URLCONF = 'celfocus_demo_appli_46060.urls'
...
WSGI_APPLICATION = 'celfocus_demo_appli_46060.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "celfocus_demo_appli_46060 API",
    "DESCRIPTION": "API documentation for celfocus_demo_appli_46060 App",
    "VERSION": "v1",
}
